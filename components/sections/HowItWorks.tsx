      ...
      <div className="steps-grid grid grid-cols-1 md:grid-cols-4 gap-8 relative">
        ...
        {[
          ...
          <div key={item.step} className="step-card opacity-0 relative text-center cursor-hover group">
            <div className="w-24 h-24 bg-brand-coral text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold relative z-10 border-8 border-surface shadow-sm group-hover:scale-105 group-hover:shadow-hover-button transition-all duration-300">
              {item.step}
            </div>
